...
function tmpl($api, $cmp, $slotset, $ctx) {
  ...
  return [api_element("span", stc0, [api_element("span", {
  ...
  }, [$cmp.hasValidKeyField ? api_element("thead", stc7, [api_element("tr", {
    classMap: stc8,
    attrs: stc9,
    key: 10,
    on: {
    ...
    attrs: stc10,
    key: 14
  }, api_flatten([api_iterator($cmp.renderedRows, function (row, rowIndex) {
  ...
  }), $cmp.isLoading ? api_element("tr", stc11, [api_element("td", {
    classMap: stc12,
    attrs: {
      "colspan": $cmp.numberOfColumns
    },
    key: 23
  }, [api_custom_element("lightning-primitive-datatable-loading-indicator", _lightningPrimitiveDatatableLoadingIndicator, stc13)])]) : null])) : null])])]), $cmp.showStatusBar ? api_custom_element("lightning-primitive-datatable-status-bar", _lightningPrimitiveDatatableStatusBar, {
    props: {
...
tmpl.stylesheetToken = "lwc-392cvb27u8q";
freezeTemplate(tmpl);
